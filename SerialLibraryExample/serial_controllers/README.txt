Name		:	Embedded Serial Communicaton Library for C++
Author		:	Aaron Reilman
Description	:	Library for serial communication in C++ using various APIs and hardware for use in Microchip Studio projects.

----------------
| Current APIs:|
----------------

1) Serial UART					:	serial_uart
2) Serial USB (CDC) using tinyusb		:	serial_usb
3) Serial SPI					:	serial_spi
